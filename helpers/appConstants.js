module.exports = {
    ...
    wrongEmail: "Please enter valid email address or password.",
    registerEmail: "Please enter a registered email address.",
    wrongPassword: "Please enter valid email address or password.",
    ...
    forgotLinkal: "Reset password link has been already sent to registered email address",
    ...
    ticketCancel: "Ticket cancel request sent successfully please wait for approval by admin.",
    ...
    bookingDetailsNotFetched: "Unable to fetch booking details. Please try again.",
